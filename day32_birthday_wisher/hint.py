...
# HINT 2: You could create a dictionary from birthdays.
# csv that looks like this:
# birthdays_dict = {
#     (month, day): data_row
# }
# HINT 3: Then you could compare and see if today's month/day matches one of
#  the keys in birthday_dict like this:
